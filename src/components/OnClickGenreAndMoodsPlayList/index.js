...
import OnclickGenreAndMoodItems from '../OnclickGenreAndMoodItems'
...
class OnClickGenreAndMoodsPlayList extends Component {
  state = {
    genresList: [],
      ...
      <div>
        ...
        <ul className="images-container">
          {genresList.items.map(eachGenre => (
            <OnclickGenreAndMoodItems
              genreAndMoodsDetailedPicks={eachGenre}
              key={eachGenre.id}
            />
          ))}
        </ul>
...
export default OnClickGenreAndMoodsPlayList
